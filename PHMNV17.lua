...
local function startFreeCam()
    ...
    -- (termasuk analog thumbstick -> jadi analog buat gerak, drag buat lihat).
    freeCamLookConns = {}
...
local function bringCharacterToFreeCam()
    ...
    if hrp and freeCamPos then
        -- pindahkan badan ke posisi kamera (tetap beku/anchored sampai Free Cam off)
        pcall(function()
...
local function openFreeCamPanel()
    ...
    info.Text = "GERAK KAMERA:\n• HP: pakai ANALOG (joystick) seperti biasa\n• PC: W A S D  (+ Space/Shift naik-turun)\nDrag layar = lihat sekeliling.\nBadan kamu DIBEKUKAN selama Free Cam."
