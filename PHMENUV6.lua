...
-- Tombol Minimize & X DIBERI JARAK lebih lebar supaya tidak salah pencet.
...
ServerBody.Size = UDim2.new(1, -16, 1, -90)
ServerBody.Position = UDim2.new(0, 8, 0, 84)
...
SrvLayout.Padding = UDim.new(0, 8)
local SrvPad = Instance.new("UIPadding", ServerBody)
SrvPad.PaddingTop = UDim.new(0, 4); SrvPad.PaddingBottom = UDim.new(0, 8)
SrvPad.PaddingLeft = UDim.new(0, 4); SrvPad.PaddingRight = UDim.new(0, 4)
